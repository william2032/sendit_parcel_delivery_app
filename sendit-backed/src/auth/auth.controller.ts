...
export class AuthController {
    ...
    @ApiOperation({
        ...
        description: 'Register a new user. Phone verification is mandatory, email verification is optional based on user choice.'
    })
    @ApiBody({type: RegisterUserDto})
    @ApiResponse({
        status: HttpStatus.CREATED,
        description: 'User registered successfully. Phone OTP sent for verification.',
    ...
    @ApiResponse({
        ...
        description: 'Invalid input data or phone number is required',
    })
    async register(
    ...
    @ApiOperation({
        summary: 'Login user',
        description: 'Login with email and password. Phone verification is required for successful login.'
    })
    ...
    @ApiOperation({
        ...
        description: 'Verify phone number using OTP. This is mandatory for account activation.'
    })
    @ApiBody({
        schema: {
            type: 'object',
    ...
    async getProfile(
        ...
        const userId = req.user.sub;
        // Get full user profile from the auth service
    ...
    async refreshToken(
        ...
        // Get the full user data to generate a proper token
        const user = await this.authService.verifyPayloadAndGetUser(req.user);
